...
var Sentry = (function (t) {
  ...
  var g =
    ("object" == typeof globalThis && b(globalThis)) ||
    ("object" == typeof window && b(window)) ||
    ("object" == typeof self && b(self)) ||
    ...
    try {
      for (
        var r = t,
          ...
          u = " > ".length,
          a = void 0,
          f = Array.isArray(n) ? n : n.keyAttrs,
          c = (!Array.isArray(n) && n.maxStringLength) || 80;
        r &&
        i++ < 5 &&
        !(
          "html" === (a = k(r, f)) ||
          (i > 1 && o + e.length * u + a.length >= c)
        );
  ...
  function k(t, n) {
    ...
    for (u = 0; u < s.length; u++)
      (i = s[u]), (o = a.getAttribute(i)) && f.push("[" + i + '="' + o + '"]');
    return f.join("");
  }
  var S = (function (t) {
      function n(n, r) {
    ...
    return "string" == typeof t
      ? (function (t) {
          ...
          var r = o(n.slice(1), 6),
            ...
            l = h.split("/");
          if (
            (l.length > 1 && ((v = l.slice(0, -1).join("/")), (h = l.pop())), h)
          ) {
            var d = h.match(/^\d+/);
            d && (h = d[0]);
          }
  ...
  function M(t, n, r) {
    return (
      void 0 === r && (r = !1),
      !!h(t) &&
        (c(n, "RegExp") ? n.test(t) : !!h(n) && (r ? t === n : t.includes(n)))
    );
  }
  function L(t, n, r) {
    return (
  ...
  function X(t) {
    try {
      return (
        (n = t),
        "undefined" != typeof Element && m(n, Element)
          ? j(t)
            ...
            nt.document.addEventListener("click", n, !1),
              ...
              ["EventTarget", "Node"].forEach(function (n) {
                ...
                r &&
                  ...
                  (C(r, "addEventListener", function (n) {
              ...
              return function () {
                ...
                return (
                  ...
                  "function" == typeof e.onreadystatechange
                    ? C(e, "onreadystatechange", function (t) {
                        return function () {
                          for (var n = [], r = 0; r < arguments.length; r++)
                            n[r] = arguments[r];
        ...
        case "unhandledrejection":
          (dt = nt.onunhandledrejection),
            (nt.onunhandledrejection = function (t) {
              return (
                ut("unhandledrejection", t), !dt || dt.apply(this, arguments)
              );
            });
          break;
        default:
  ...
  function at(t) {
    return (
      void 0 === t && (t = []),
      "Request" in nt && m(t[0], Request) && t[0].method
  ...
  function kt(t, n, r, e, i) {
      ...
      void 0 === i &&
        ...
        (i = [
          function (t) {
            ...
            for (var n = 0; n < a.length; n++) if (a[n] === t) return !0;
            return a.push(t), !1;
          },
          function (t) {
            if (u) a.delete(t);
    ...
    if (
      ...
      (["number", "boolean", "string"].includes(typeof n) &&
        ("number" != typeof (f = n) || f == f))
    )
      return n;
    var h = (function (t, n) {
      try {
        return "domain" === t && n && "object" == typeof n && n.i
          ? "[Domain]"
          : "domainEmitter" === t
          ? "[DomainEmitter]"
  ...
  var Ot = (function () {
    function t(t) {
      ...
      (this.o = lt.PENDING),
        ...
        (this.h = function (t, r) {
          n.o === lt.PENDING &&
            (p(r) ? r.then(n.v, n.l) : ((n.o = t), (n.p = r), n.m()));
        }),
        (this.m = function () {
          if (n.o !== lt.PENDING) {
            var t = n.u.slice();
    ...
    return {
      ...
      add: function (e) {
        if (!(void 0 === t || n.length < t))
          return xt(
            new S("Not adding Promise because buffer limit was reached.")
          );
        var i = e();
        return (
  ...
  function Xt(t, n) {
    ...
    function s(t) {
      "string" == typeof c
        ? (c = "string" == typeof t ? c + t : [Pt(c, n), t])
      ...
      try {
        for (
          ...
          if (g)
            try {
              for (
                var _ = ((f = void 0), i(g.split(";"))), j = _.next();
                !j.done;
                j = _.next()
              ) {
                h[j.value] = r + E;
  ...
  var Kt = (function () {
    ...
    return (
      ...
      (t.prototype.setTag = function (t, n) {
        var r;
        return (
          (this.R = e(e({}, this.R), (((r = {})[t] = n), r))), this.U(), this
        );
      }),
      ...
      (t.prototype.setExtra = function (t, n) {
        var r;
        return (
          (this.T = e(e({}, this.T), (((r = {})[t] = n), r))), this.U(), this
        );
      }),
      ...
      (t.prototype.applyToEvent = function (t, n) {
        if (
          ...
          this.R &&
            ...
            (t.tags = e(e({}, this.R), t.tags)),
          this.O &&
            Object.keys(this.O).length &&
            (t.user = e(e({}, this.O), t.user)),
          this.D &&
  ...
  function nn() {
    var t,
      n = Zt();
    return (
      ((t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !rn(n).isOlderThan(4)) ||
        en(n, new Qt()),
      rn(n)
    );
  }
  ...
  function hn(t, n) {
    (n[t.name] = t),
      -1 === sn.indexOf(t.name) && (t.setupOnce(Yt, nn), sn.push(t.name));
  }
  function ln(t, n, r, i) {
        ...
        ? (function (t, n, r) {
            ...
            t.contexts &&
              ...
              t.contexts.trace.data &&
                (i.contexts.trace.data = _t(t.contexts.trace.data, n, r)));
            t.spans &&
    ...
    return (
      ...
      (t.prototype.sendEvent = function (t, n) {
        ...
        if ((void 0 === n && (n = {}), this.nt)) {
          ...
          try {
            for (
              var u = i(n.attachments || []), a = u.next();
              !a.done;
              a = u.next()
            ) {
              o = Ut(
                ...
                $t(
                  a.value,
                  this.tt.transportOptions &&
                    this.tt.transportOptions.textEncoder
                )
              );
            }
          } catch (t) {
      ...
      (t.prototype.st = function (t, n, r) {
        ...
        return this.ct(t, n, r)
          ...
          .then(function (o) {
            if (null === o)
              throw (
                (i.recordDroppedEvent("before_send", v, t),
        ...
        throw (
          ...
          on(function (r) {
            r.addEventProcessor(function (t) {
              return (
                n.mechanism && (bt(t, void 0, void 0), gt(t, n.mechanism)),
                (t.extra = e(e({}, t.extra), {
                  arguments: i,
                })),
                t
            ...
            this.options.dom &&
              ot(
                ...
                (function (t) {
                  function n(n) {
                    var r,
                      e = "object" == typeof t ? t.serializeAttribute : void 0,
                      i =
                        "object" == typeof t &&
  ...
  function Fn(t) {
    ...
    if ("assert" === t.level) {
      ...
      (e.message =
        "Assertion failed: " + (I(t.args.slice(1), " ") || "console.assert")),
  ...
  var zn = (function (t) {
      function n(n) {
        ...
        return (
          ...
          n.sendClientReports &&
            xn.document &&
            xn.document.addEventListener("visibilitychange", function () {
        ...
        (n.prototype.ht = function () {
          ...
          if (0 !== t.length && this.nt) {
            var n,
              r,
              e,
              i = fn(this.nt, this.tt),
              o =
                ((n = t),
                qt(
                  (r = this.tt.tunnel && O(this.nt))
                    ? {
                        dsn: r,
                      }
                    : {},
            ...
            try {
              if (
                "[object Navigator]" ===
                  Object.prototype.toString.call(xn && xn.navigator) &&
                "function" == typeof xn.navigator.sendBeacon &&
                !this.tt.transportOptions
              )
    ...
    ot("unhandledrejection", function (t) {
      ...
      if (r.getIntegration(dr)) {
        ...
        try {
          "reason" in t
            ? (u = t.reason)
            : "detail" in t && "reason" in t.detail && (u = t.detail.reason);
        } catch (t) {}
      ...
      return (
        (t.prototype.setupOnce = function () {
          this.tt.setTimeout && C(xn, "setTimeout", _r),
            ...
            this.tt.XMLHttpRequest &&
              "XMLHttpRequest" in xn &&
              C(XMLHttpRequest.prototype, "send", kr);
        ...
        return function (r, e, i) {
          try {
            "function" == typeof e.handleEvent &&
              (e.handleEvent = Dn(e.handleEvent, {
                mechanism: {
                  data: {
          ...
          Yt(function (r, e) {
            ...
            return i
              ? (function (t, n, r, e, i) {
                ...
                })(n.getOptions().stackParser, i.dt, i.yt, r, e)
              : r;
          });
      }),
      (t.id = "LinkedErrors"),
  ...
  function Or(t, n, r, e, i) {
    if ((void 0 === i && (i = []), !m(r[e], Error) || i.length + 1 >= n))
      return i;
    var o = Nn(t, r[e]);
          ...
          Yt(function (n) {
            if (nn().getIntegration(t)) {
              ...
              var r =
                  ...
                  (xn.location && xn.location.href),
                i = (xn.document || {}).referrer,
                o = (xn.navigator || {}).userAgent,
                u = e(
                  e(
                    e({}, n.request && n.request.headers),
                    i && {
                      Referer: i,
                    }
                  ),
    ...
    (t.init = function (t) {
      void 0 === t && (t = {}),
        ...
        void 0 === t.release &&
          ...
          xn.SENTRY_RELEASE &&
            xn.SENTRY_RELEASE.id &&
            (t.release = xn.SENTRY_RELEASE.id)),
